...
export async function loadHDR(buffer) {
    ...
    function logError(logError_code, msg) {
        switch (logError_code) {
            case READ_ERROR: console.error("Read Error: " + (msg || ''));
                break;
            case WRITE_ERROR: console.error("Write Error: " + (msg || ''));
                break;
            case FORMAT_ERROR: console.error("Bad File Format: " + (msg || ''));
                break;
            default:
            case MEMORY_ERROR: console.error("Error: " + (msg || ''));
        }
